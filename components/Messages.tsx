...
import { Play, Calendar, Clock, Download, Share2, BookOpen, Mic, Users, ArrowLeft } from "lucide-react";
...
export function Messages() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
            <div className="flex items-center justify-center mb-4">
              <BookOpen className="w-8 h-8 text-brand-purple-light mr-3" />
              <span className="text-brand-purple-light font-semibold tracking-wide uppercase text-sm">Messages</span>
            </div>
      ...
      {/* Main Content - Exact Section from Sermons.tsx */}
      <div className="section-padding">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="lg:order-2 space-y-8">
                <div>
                  ...
                  <h2 className="font-heading text-3xl text-brand-navy mb-4">
          ...
          {/* Recent Sermons Grid */}
          <div className="mb-16">
            <h2 className="font-heading text-2xl text-brand-navy mb-8 text-center">Recent Messages</h2>
